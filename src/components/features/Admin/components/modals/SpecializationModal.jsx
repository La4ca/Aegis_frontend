        ...
        <form onSubmit={handleSubmit}>
          ...
          {isEditing && (
            <div className="info-note">
              <AlertCircle size={14} />
              <span>
                Specialization status is automatically determined by the number
                of doctors assigned. It will be <strong>Active</strong> if at
                least one doctor has this specialization, otherwise{" "}
